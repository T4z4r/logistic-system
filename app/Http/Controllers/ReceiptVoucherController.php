...
class ReceiptVoucherController extends Controller
{
    ...
    {
        $voucherType = VoucherType::where('name', 'Receipt')->where('company_id', auth()->user()->company_id)->first();
        ...
        return view('vouchers.receipt.index', compact('vouchers', 'ledgers', 'costCenters', 'voucherType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $voucherType = VoucherType::where('name', 'Receipt')->where('company_id', auth()->user()->company_id)->firstOrFail();
        ...
        return redirect()->route('vouchers.receipt.index')->with('success', 'Receipt voucher created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vouchers.receipt.index')->with('success', 'Receipt voucher updated successfully.');
    }
    ...
    public function destroy($id)
    {
        $voucher = Voucher::where('id', $id)->where('company_id', auth()->user()->company_id)->firstOrFail();
        $voucher->delete();
        return redirect()->route('vouchers.receipt.index')->with('success', 'Receipt voucher deleted successfully.');
    }
