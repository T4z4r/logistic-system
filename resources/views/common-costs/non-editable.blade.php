...
@section('content')
    ...
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-1">Non-Editable Common Costs</h1>
          <h2 class="fs-base lh-base fw-medium text-muted mb-0">View all non-editable common costs in the system</h2>
        </div>
        <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-alt">
            ...
            <li class="breadcrumb-item" aria-current="page">Non-Editable</li>
          </ol>
        </nav>
      </div>
    </div>
  ...
  <!-- Page Content -->
  <div class="content">
    <!-- Non-Editable Common Costs Block -->
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Non-Editable Common Costs List</h3>
    ...
    <!-- END Non-Editable Common Costs Block -->
  </div>
  <!-- END Page Content -->
@endsection