    ...
    <div class="mt-2 mb-1 card card border-0 border-top  border-top-width-3 border-top-main  rounded-0 p-2 ">
        ...
        <div class="card-head ">
            <div class="p-2">
                ...
                {{-- / --}}
                {{-- For small Screens --}}
                <p class="lead text-black d-sm-none d-block "><small> <i class="ph-calendar-check text-brand-secondary "></i>
                        Allocation Requests</small></p>
                {{-- / --}}

                @can('create-allocation')
                    <a href="{{ route('flex.add-allocation') }}" class="btn btn-main btn-sm float-end">
                        <i class="ph-plus me-2"></i> New Request
                    </a>
                @endcan
                <a href="{{ route('flex.print-allocations') }}" class="btn btn-main btn-sm float-end mx-1" title="Add New Truck">
        ...
        <ul class="nav nav-tabs mb-3 px-2" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="#incomplete" class="nav-link  @if ($level == null) active @endif" data-bs-toggle="tab" aria-selected="true" role="tab"
                    tabindex="-1">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade table-responsive @if ($level == null) active show @endif " id="incomplete" role="tabpanel">
                    ...
                    <table id="" class="table table-striped table-bordered datatable-basic">
                        ...
                        <tbody>
                            ...
                            @forelse($incomplete as $item)
                                @php
                                    $estimateRevenue = App\Models\TruckAllocation::where('allocation_id', $item->id)->sum('income');
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge {{ $item->status == '1' ? ' bg-success text-warning' : ' bg-info text-danger' }}  bg-opacity-10 ">
                                    ...
                                    <td>
                                        ...
                                        @can('notify-allocation')
                                            <a href="javascript:void(0)" title="Renotify"
                                                class="icon-2 info-tooltip btn btn-main btn-sm m-1"
                                            ...
                                            @if ($level->level_name == $item->approval_status)
                                                ...
                                                <div id="myCollapsibleDiv" class="collapse">
                                                    ...
                                                    <form action="{{ url('trips/approve-allocation') }}"
                                                        ...
                                                        <button type="submit" class="btn btn-sm btn-main float-end"
            ...
            <div class="tab-pane fade table-responsive  @if ($level) active show @endif" id="approvalTab"
                role="tabpanel">
                {{-- @can('view-pending-allocations') --}}
                <table id="" class="table table-striped table-bordered datatable-basic">
                    <thead>
                                        ...
                                        <td>
                                            ...
                                            @if ($level && $item->status > 0)
                                                @if ($level->level_name == $item->approval_status)
                                                    ...
                                                    <a href="" class="btn btn-sm btn-danger edit-button d-none d-block "
                                                        title="Dispprove Allocation" data-bs-toggle="modal"
                                                        data-bs-target="#disapproval" data-id="{{ $item->id }}"
                                                        data-name="{{ $item->name }}"
                                                        data-description="{{ $item->amount }}">
                                                    ...
                                                    <button type="button" class="btn btn-success mx-1 btn-sm d-sm-none d-block "
                                                    hidden
                                                    data-bs-toggle="collapse" data-bs-target="#myCollapsibleDiv">
                                                    <i class="ph-check-circle"></i>
                        ...
                        <form action="{{ url('trips/approve-allocation') }}" id="disapprove_form" method="post">
                            ...
                            <div class="row ">
                                <div class="col-4 mx-auto">
                                    ...
                                    <button type="button" id="approve_no"
