...
@section('content')
    ...
    <div class="content1  p-2 rounded-0">
        ...
        <div class="block block-rounded rounded-0 shadow-sm mb-2" hidden>
            <div class="block-content block-content-full">
                <div class="row text-center">
                    ...
                    <div class="col-sm-3 py-3">
                        <div class="d-flex align-items-center justify-content-center mb-2">
                            <span class="bg-success bg-opacity-10 text-light lh-1 rounded-pill p-2 me-3">
        ...
        <div class="block block-rounded rounded-0 shadow-sm">
            <div class="block-header block-header-default">
                <h3 class="block-title"><i class="fa fa-truck text-brand-secondary me-2"></i>Backload Trips</h3>
                <div class="block-options">
                    <a href="#" class="btn btn-sm btn-alt-primary" title="Print Trips" hidden>
                            ...
                            <tbody>
                                ...
                                @foreach ($pending as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($linked == null)
                                                <span class="badge bg-info bg-opacity-10 text-light">Not Linked</span>
                                            @else
                                        ...
                                        <td>
                                            @if ($linked == null)
                                                <button class="{{ $item->goingload_id == 2 ? 'disabled' : '' }} btn btn-sm btn-alt-primary edit-button me-1"
                            ...
                            <tbody>
                                ...
                                @foreach ($active as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge {{ $item->state == 4 ? 'bg-success text-success' : 'bg-info text-light' }} bg-opacity-10">
            ...
            <div class="modal-content">
                <form action="{{ url('trips/link-trip') }}" id="linking_form" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" id="linking_btn" class="btn btn-alt-primary">Link Trips</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $("#linking_form").submit(function(e) {
            $("#linking_btn").html("<i class='fa fa-spinner spinner me-2'></i> Linking Trips").addClass('disabled');
        });
    </script>
@endsection