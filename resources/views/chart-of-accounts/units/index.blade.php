                        ...
                        @foreach ($units as $unit)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('chart.units.destroy', $unit->id) }}" method="POST"
                    ...
                    <form action="{{ route('chart.units.store') }}" method="POST" id="createUnitForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('symbol') is-invalid @enderror"
                                id="create_symbol" name="symbol" value="{{ old('symbol') }}">
                            @error('symbol')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('is_compound') is-invalid @enderror" id="create_is_compound"
                                name="is_compound">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('base_unit_id') is-invalid @enderror"
                                id="create_base_unit_id" name="base_unit_id">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01"
                                ...
                                id="create_conversion_factor" name="conversion_factor"
        ...
        <div class="modal fade" id="editUnitModal{{ $unit->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('chart.units.update', $unit->id) }}" method="POST"
                            id="editUnitForm{{ $unit->id }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="edit_name_{{ $unit->id }}" class="form-label">Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="edit_name_{{ $unit->id }}" name="name"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('symbol') is-invalid @enderror"
                                    id="edit_symbol_{{ $unit->id }}" name="symbol"
                            ...
                            <div class="mb-3">
                                <label for="edit_is_compound_{{ $unit->id }}" class="form-label">Compound
                                    Unit</label>
                                <select class="form-control @error('is_compound') is-invalid @enderror"
                                    id="edit_is_compound_{{ $unit->id }}" name="is_compound">
                                    <option value="0"
                                        {{ old('is_compound', $unit->is_compound) == '0' ? 'selected' : '' }}>No</option>
                                    <option value="1"
                                        {{ old('is_compound', $unit->is_compound) == '1' ? 'selected' : '' }}>Yes</option>
                                </select>
                                @error('is_compound')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label for="edit_conversion_factor_{{ $unit->id }}" class="form-label">Conversion
                                    Factor</label>
                                <input type="number" step="0.01"
                                    class="form-control @error('conversion_factor') is-invalid @enderror"
                                    id="edit_conversion_factor_{{ $unit->id }}" name="conversion_factor"
