    ...
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-1">Truck Management</h1>
          <h2 class="fs-base lh-base fw-medium text-muted mb-0">Manage all trucks in the system</h2>
        </div>
    ...
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        ...
        <div class="block-options">
          ...
          <a href="{{ route('trucks.inactive') }}" class="btn btn-secondary">View Inactive Trucks</a>
        </div>
      </div>
