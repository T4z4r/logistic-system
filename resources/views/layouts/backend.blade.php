    ...
    <nav id="sidebar" aria-label="Main Navigation">
      ...
      <div class="content-header">
        ...
        <a class="font-semibold text-dual" href="/">
          ...
          <span class="smini-hide fs-5 tracking-wider">Krismo<span class="fw-normal text-danger">ERP</span></span>
        </a>
        <!-- END Logo -->
      ...
      <div class="content py-3">
        <div class="row fs-sm">
          <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="https://1.envato.market/ydb" target="_blank">krismo</a>
          </div>
          <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
            <a class="fw-semibold" href="https://1.envato.market/AVD6j" target="_blank">krismoERP</a> &copy; <span data-toggle="year-copy"></span>
          </div>
        </div>
      </div>
    </footer>
