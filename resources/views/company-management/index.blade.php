                    ...
                    <form action="{{ route('company.management.store') }}" method="POST" id="createCompanyForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tax_number') is-invalid @enderror"
                                id="create_tax_number" name="tax_number" value="{{ old('tax_number') }}">
                            @error('tax_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('currency_id') is-invalid @enderror" id="create_currency_id"
                                name="currency_id">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('financial_year_start') is-invalid @enderror"
                                id="create_financial_year_start" name="financial_year_start"
        ...
        <div class="modal fade" id="editCompanyModal{{ $company->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('company.management.update', $company->id) }}" method="POST"
                            id="editCompanyForm{{ $company->id }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="edit_name_{{ $company->id }}" class="form-label">Company Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="edit_name_{{ $company->id }}" name="name"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" id="edit_address_{{ $company->id }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('tax_number') is-invalid @enderror"
                                    id="edit_tax_number_{{ $company->id }}" name="tax_number"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('currency_id') is-invalid @enderror"
                                    id="edit_currency_id_{{ $company->id }}" name="currency_id">
                                    <option value="">Select Currency</option>
                                    @foreach ($currencies as $currency)
                                        <option value="{{ $currency->id }}"
                                            {{ old('currency_id', $company->currency_id) == $currency->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                <label for="edit_financial_year_start_{{ $company->id }}" class="form-label">Financial
                                    Year Start</label>
                                <input type="date"
                                    class="form-control @error('financial_year_start') is-invalid @enderror"
                                    id="edit_financial_year_start_{{ $company->id }}" name="financial_year_start"
