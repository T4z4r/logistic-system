...
@section('content')
    ...
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-1">Non-Editable Fuel Costs</h1>
          <h2 class="fs-base lh-base fw-medium text-muted mb-0">View all non-editable fuel costs in the system</h2>
        </div>
  ...
  <!-- Page Content -->
  <div class="content">
    <!-- Non-Editable Fuel Costs Block -->
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Non-Editable Fuel Costs List</h3>
    ...
    <!-- END Non-Editable Fuel Costs Block -->
  </div>
  <!-- END Page Content -->
@endsection
