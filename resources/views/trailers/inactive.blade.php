...
@section('content')
    ...
    <div class="content content-full">
      <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
        <div class="flex-grow-1">
          <h1 class="h3 fw-bold mb-1">Inactive Trailers</h1>
          <h2 class="fs-base lh-base fw-medium text-muted mb-0">View all inactive trailers in the system</h2>
        </div>
  ...
  <!-- Page Content -->
  <div class="content">
    <!-- Inactive Trailers Block -->
    <div class="block block-rounded">
      <div class="block-header block-header-default">
        <h3 class="block-title">Inactive Trailers List</h3>
        <div class="block-options">
          <a href="{{ route('trailers.create') }}" class="btn btn-primary">Add New Trailer</a>
          <a href="{{ route('trailers.active') }}" class="btn btn-secondary">View Active Trailers</a>
        </div>
      </div>
