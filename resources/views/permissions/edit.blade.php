                ...
                <div class="p-6 text-gray-900">
                    <form action="{{  route('permissions.update',$permission->id) }}" method="post" >
                        ...
                        <div class="my-3">
                            ...
                            <div class="mb-3">
                                <input type="text" name="name" value="{{ $permission->name }}"  id="name" placeholder="Enter Name"  class="border-grey-300 shadow-sm w-1/2 rounded-lg" id="">
                                @error('name')
