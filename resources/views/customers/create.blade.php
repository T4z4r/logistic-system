        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-1">
                <div class="flex-grow-1">
                    <h5 class="h5 fw-bold mb-1 text-main">Create Customer</h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="contact_person" id="contact_person"
                                ...
                                value="{{ old('contact_person') }}" placeholder="Enter contact person's name">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" name="VRN" id="VRN"
                                class="form-control @error('VRN') is-invalid @enderror" value="{{ old('VRN') }}"
