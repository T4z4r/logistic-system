        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-1">
                <div class="flex-grow-1">
                    <h5 class="h5 fw-bold mb-1 text-main">Edit Customer</h5>
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">
                            <a class="link fall back to a previous version of the document or software-fx text-main"
                ...
                @if (isset($customer) && $customer->id)
                    <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" name="abbreviation" id="abbreviation"
                                    ...
                                    value="{{ old('abbreviation', $customer->abbreviation) }}">
                                @error('abbreviation')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <select name="created_by" id="created_by"
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}"
                                            {{ old('created_by', $customer->created_by) == $user->id ? 'selected' : '' }}>
                                            {{ $user->name }}</option>
                                    @endforeach
                                </select>
                                @error('created_by')
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" name="credit_term" id="credit_term"
                                    ...
                                    value="{{ old('credit_term', $customer->credit_term) }}">
                                @error('credit_term')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-alt-primary float-end mb-3">
